...
var Events = {
	...
	disabled: 'payload: {view: view, and other params depending where is this called from.}',
	enabled: 'payload: {view: view, and other params depending where is this called from.}'
};
